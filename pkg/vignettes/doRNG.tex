...
\bibliography{/tmp/Rpkglib_1def57af461e/doRNG/REFERENCES}
...
{\small \Rpkg{doRNG} -- Version 1.5.3}}
...
\end{alltt}
\begin{verbatim}
## [1] 1.028 2.274 3.944 4.558 5.609
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## 1         rPar(10)           50   0.396    1.000     0.396    0.000          0         0
## 2         rRNG(10)           50   0.755    1.907     0.732    0.020          0         0
## 3         rPar(50)           50   1.323    3.341     1.320    0.000          0         0
## 4         rRNG(50)           50   2.259    5.705     2.236    0.020          0         0
## 5        rPar(100)           50   2.512    6.343     2.508    0.000          0         0
## 6        rRNG(100)           50   4.263   10.765     4.240    0.016          0         0
## 8    rRNG(10, 0.1)           50  51.308  129.566     1.212    0.040          0         0
## 7    rPar(10, 0.1)           50  51.552  130.182     1.481    0.008          0         0
## 9  rPar(100, 0.01)           50  54.823  138.442     4.492    0.040          0         0
## 10 rRNG(100, 0.01)           50  59.591  150.482     9.096    0.112          0         0
\end{verbatim}
\end{kframe}
\end{knitrout}
