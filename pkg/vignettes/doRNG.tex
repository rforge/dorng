...
\bibliography{/tmp/Rpkglib_79a614f7b6ea/doRNG/REFERENCES}
...
\end{alltt}
\begin{verbatim}
## [1] 1.574 2.578 3.071 4.045 5.955
\end{verbatim}
\end{kframe}
\end{knitrout}
...
## res1    31204    31204    31204    31204    31204
##         31214    31222    31214    31222    31214
## res2    31235    31243    31251    31243    31235
\end{verbatim}
\begin{alltt}
...
\hlstd{err} \hlkwb{<-} \hlkwd{try}\hlstd{(}\hlkwd{foreach}\hlstd{(}\hlkwc{i} \hlstd{=} \hlnum{1}\hlopt{:}\hlnum{10}\hlstd{)} \hlopt{%:%} \hlkwd{when}\hlstd{(i}\hlopt{%%}\hlnum{2} \hlopt{==} \hlnum{0}\hlstd{)} \hlopt{%dorng%} \hlstd{\{}
...
## 1        rPar(10)            5   0.029    1.000     0.028    0.000          0         0
## 3        rPar(25)            5   0.055    1.897     0.056    0.000          0         0
## 2        rRNG(10)            5   0.055    1.897     0.052    0.004          0         0
## 4        rRNG(25)            5   0.092    3.172     0.092    0.000          0         0
## 5        rPar(50)            5   0.094    3.241     0.092    0.000          0         0
## 6        rRNG(50)            5   0.159    5.483     0.160    0.000          0         0
## 9  rPar(10, 0.05)            5   2.619   90.310     0.116    0.000          0         0
## 10 rRNG(10, 0.05)            5   2.637   90.931     0.132    0.000          0         0
## 7  rPar(50, 0.01)            5   2.950  101.724     0.420    0.004          0         0
## 8  rRNG(50, 0.01)            5   3.081  106.241     0.524    0.032          0         0
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] doRNG_1.5.4      rngtools_1.2.2   pkgmaker_0.16.4  registry_0.2     doParallel_1.0.3
[6] iterators_1.0.6  foreach_1.4.1    knitr_1.4.1     

loaded via a namespace (and not attached):
[1] codetools_0.2-8 compiler_3.1.0  digest_0.6.3    evaluate_0.4.7  formatR_0.9    
[6] highr_0.2.1     stringr_0.6.2   tools_3.1.0     xtable_1.7-1   
\end{verbatim}
\end{kframe}
\end{knitrout}
