...
\bibliography{C:/Users/ShenorrLab.MEDICINE/AppData/Local/Temp/Rpkglib_20fc4cc525ec/doRNG/REFERENCES}
...
\end{alltt}
\begin{verbatim}
## [1] 1.852 2.302 3.272 4.903 5.141
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Loading required package: rngtools}}\begin{alltt}
...
## res1     8352     8352     8352     8352     8352
##          8572     8992     8572     8992     8992
## res2     9028     8356     7536     8356     7536
\end{verbatim}
\begin{alltt}
...
## 1         rPar(10)           50    1.24    1.000      1.22     0.00         NA        NA
## 2         rRNG(10)           50    2.35    1.895      2.17     0.19         NA        NA
## 3         rPar(50)           50    4.05    3.266      4.04     0.00         NA        NA
## 4         rRNG(50)           50    7.41    5.976      7.17     0.16         NA        NA
## 5        rPar(100)           50    7.66    6.177      7.64     0.00         NA        NA
## 6        rRNG(100)           50   13.02   10.500     12.76     0.12         NA        NA
## 7    rPar(10, 0.1)           50   51.18   41.274      0.80     0.00         NA        NA
## 8    rRNG(10, 0.1)           50   52.58   42.403      2.25     0.17         NA        NA
## 9  rPar(100, 0.01)           50   56.13   45.266      6.10     0.00         NA        NA
## 10 rRNG(100, 0.01)           50   62.90   50.726     12.11     0.13         NA        NA
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] doRNG_1.5        rngtools_1.1     pkgmaker_0.10.4  doParallel_1.0.1 iterators_1.0.6 
[6] foreach_1.4.0    knitr_1.0.5     

loaded via a namespace (and not attached):
[1] codetools_0.2-8 compiler_2.15.2 digest_0.6.0    evaluate_0.4.3  formatR_0.7    
[6] stringr_0.6.2   tools_2.15.2    xtable_1.7-0   
\end{verbatim}
\end{kframe}
\end{knitrout}
